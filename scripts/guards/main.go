...
var guards = []guard{
	{
		...
		pkg:  "./runtime", run: "TestATruncatedDocumentIsDetectedAtEOF",
	},
	{
		...
		pkg:  "./runtime", run: "TestAJSONObjectIsRefusedByName",
	},
	{
		name: "encoders: row by row bytes equal one shot bytes",
		file: "runtime/encode.go",
		old:  "\tprefix := byte(',')\n\tif !e.started {",
		new:  "\tprefix := byte('[')\n\tif !e.started {",
		pkg:  "./runtime", run: "TestStreamedAndBufferedEncodingsAreIdentical",
	},
	{
		...
		old:  "\tout.WriteString(\"\\r\\n\")\n}",
		new:  "\tout.WriteString(\"\\n\")\n}",
		pkg:  "./runtime", run: "TestCSVTakesItsHeaderFromTheFirstRowAndEndsLinesWithCRLF",
	},
	{
	...
	},
	{
		...
		file: "runtime/json.go",
		old:  "c.enc.SetEscapeHTML(false)",
		new:  "c.enc.SetEscapeHTML(true)",
		pkg:  "./runtime", run: "TestEncodingNeverEscapesHTMLAndMeasuresBytesNotCharacters",
	},
	{
		name: "inputs: a block type this runtime does not know is refused",
		file: "runtime/envelope.go",
		old:  "	if kind == INLINE || kind == REFERENCE {",
		new:  "	if kind == INLINE || kind == REFERENCE || kind != \"\" {",
		pkg:  "./runtime", run: "TestABlockTypeThisRuntimeDoesNotKnowRefusesToMaterialise",
	},
	{
	...
	},
	{
		...
		new:  "_ = value",
		pkg:  "./runtime", run: "TestMaterialisingTwiceCostsOneDownload",
	},
	{
		...
		pkg:  "./runtime", run: "TestAValueThatWouldNotFitIsRefusedBeforeItIsFetched",
	},
	{
		...
		pkg:  "./runtime", run: "TestIterationIsReEntrantRatherThanASpentGenerator",
	},
	{
		...
		pkg:  "./runtime", run: "TestAMissingInputNamesTheParentsThatExist",
	},
	{
		...
		pkg:  "./runtime", run: "TestSizeIsMeasuredInBytesNotCharacters",
	},
	{
		...
		new:  "",
		pkg:  "./runtime", run: "TestRowCollectionCountsTheArrayPunctuation",
	},
	{
		...
		pkg:  "./runtime", run: "TestABlankRoutingKeyIsRefused",
	},
	{
		...
		pkg:  "./runtime", run: "TestRowOutputRefusesBeforeItCouldExceedGuestMemory",
	},
	{
		...
		old:  "\tcommitted := false\n\tdefer func() {\n\t\tif !committed {\n\t\t\tsink.Abort()\n\t\t}\n\t}()\n",
		new:  "\tcommitted := false\n\t_ = committed\n",
		pkg:  "./runtime", run: "TestAPanicMidStreamAbortsTheUploadToo",
	},
	{
		...
		new:  "\tif false {\n\t\treturn &OutputTooLarge{",
		pkg:  "./runtime", run: "TestRowsStopBeingCollectedOnceTheyCannotBeInline",
	},
	{
		name: "http: a rejected signature echoed by storage is scrubbed",
		file: "runtime/http.go",
		old:  "\t\t\tif len(value) >= 8 {\n\t\t\t\ttext = strings.ReplaceAll(text, value, \"[scrubbed]\")\n\t\t\t}",
		new:  "\t\t\tif len(value) >= 8 {\n\t\t\t\ttext = strings.ReplaceAll(text, value, value)\n\t\t\t}",
		pkg:  "./runtime", run: "TestAnErrorStatusCarriesTheProvidersDiagnosisWithTheSignatureScrubbed",
	},
	{
	...
	},
	{
		...
		pkg:  "./runtime", run: "TestAFailureNeverLogsTheSignature",
	},
	{
		...
		pkg:  "./runtime", run: "TestAFailedReadIsRetryableOnTheWorkflowPolicy",
	},
	{
		...
		new:  "",
		pkg:  "./runtime", run: "TestABodyThatKeepsMovingIsNeverCutByTheTimeout",
	},
	{
	...
	},
	{
		...
		file: "runtime/multipart.go",
		old:  "\tif len(p.etags) == 0 {\n\t\tp.Abort()\n\n\t\treturn 0, nil\n\t}",
		new:  "",
		pkg:  "./runtime", run: "TestAnEmptyUploadIsAbortedNotCompleted",
	},
	{
		...
		old:  `if etag == "" {`,
		new:  `if false {`,
		pkg:  "./runtime", run: "TestAPartWithoutAnETagIsAStorageMisconfiguration",
	},
	{
		...
		old:  "\t\tif !committed {\n\t\t\tsink.Abort()\n\t\t}",
		new:  "\t\tif !committed {\n\t\t\t_ = sink\n\t\t}",
		pkg:  "./runtime", run: "TestAFailureMidStreamAbortsTheUpload",
	},
	{
		name: "outstream: close commits the block",
		file: "runtime/outstream.go",
		old:  "\to.written = &Written{\n\t\tblock: block,\n\t}\n",
		new:  "\t_ = block\n",
		pkg:  "./runtime", run: "TestTheReferenceMustStillBeReturned",
	},
	{
		...
		pkg:  "./runtime", run: "TestAHandlerThatFailedSendsNothing",
	},
	{
		...
		pkg:  "./runtime", run: "TestAnUnknownCategoryIsReportedAsPermanent",
	},
	{
		...
		new:  "return false",
		pkg:  "./runtime", run: "TestAFailureWithoutADelayAborts",
	},
	{
		...
		old:  "\t\t\tRetry: &Retry{\n\t\t\t\tAbort: true,\n\t\t\t},\n",
		new:  "",
		pkg:  "./runtime", run: "TestABugInTheNodeIsPermanentAndNamed",
	},
	{
		...
		pkg:  "./runtime", run: "TestAPanicInTheNodeIsAFailedEnvelopeNotACrash",
	},
	{
		...
		pkg:  "./runtime", run: "TestAFailureMessageIsBoundedForTheTransport",
	},
	{
		...
		pkg:  "./runtime", run: "TestTheEnvelopeIsWrittenCompactAndInOrder",
	},
	{
	...
	},
	{
		...
		pkg:  "./authoring", run: "TestAHandleFromAnotherWorkflowIsRefused",
	},
	{
